...
public class Task1 {
    public static void main(String[] args) {
        //String str = getStringFromFile("Task1.txt");
    ...
    static String[] getSplitString(String str) {
        ...
        ArrayList<String> parametres = new ArrayList<String>(); //ArrayList тут использую для того, чтобы не заморачиваться с размером массива
